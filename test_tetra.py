...
logger = analyze.log(filename = '%s/randomization.txt'%(out_dir),quantities=['num_particles','potential_energy','kinetic_energy','temperature'] ,period = 1e4, overwrite=True)
run(5e6)
dumper.disable()
logger.disable()
langevin1.disable()
...
logger = analyze.log(filename = '%s/test_production.txt'%(out_dir),quantities=['num_particles','potential_energy','pair_lj_energy','kinetic_energy','temperature'] ,period = 5e3, overwrite=True)
run(1e7)
dumper.disable()
logger.disable()
